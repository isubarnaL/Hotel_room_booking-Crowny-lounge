...
$con = connect();
    ...
    if (isset($_POST['addItem'])){
        ...
        $checkSQL = "SELECT * FROM `menu_room` WHERE hotel_id = '$res_id' and item_name = '$itemname' and price = '$price';";
                ...
                if (isset($_FILES['image'])) {
                 // files handle
                    ...
                    if ($extension =="jpg" || $extension =="png" || $extension =="jpeg"){
                        ...
                        $iquery="INSERT INTO `menu_room`( `hotel_id`, `item_name`, `madeby`, `food_type`, `price`, `image`) 
