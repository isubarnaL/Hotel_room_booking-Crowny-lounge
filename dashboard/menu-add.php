							...
							<section class="panel">
								<header class="panel-heading">
									...
									<p class="panel-subtitle">
										For add <code>Rooms</code> please fill up all field.
									</p>
								</header>
									...
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group">
												...
												<textarea class="form-control" name="madeby" rows="1"
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<select data-plugin-selectTwo class="form-control populate"
														...
														<option value="Fast Food">Kathmandu</option>
														<option value="Fast Food">Bhaktapur</option>
														<option value="Fast Food">Lalitpur</option>
