...
<body>
  ...
  <section class="home-slider owl-carousel" style="height: 400px;">
    <div class="slider-item" style="background-image: url('images/login.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="col-md-12 dish-menu">
        ...
        <div class="nav nav-pills justify-content-center ftco-animate" id="v-pills-tab" role="tablist"
          ...
          <a class="nav-link py-3 px-4 active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab"
            aria-controls="v-pills-home" aria-selected="true"><span class="flaticon-meat"></span> Login</a>
...
if (isset($_POST['login'])) {
  ...
  $emailSQL = "SELECT * FROM hotel_info WHERE email = '$email';";

  $passwordSQL = "SELECT * FROM hotel_info WHERE email = '$email' And password = '$password';";
  ...
  if ($emailResult->num_rows <= 0) {
    ...
    // $SQL = "SELECT * FROM hotel_info WHERE email = '$email' And password = '$password' AND approve_status=1";

    $SQL = "SELECT * FROM hotel_info WHERE email = '$email' And password = '$password'";

    $result = $con->query($SQL);

    foreach ($result as $r) {
      $_SESSION['id'] = $r['id'];
      $_SESSION['name'] = $r['hotel_name'];
